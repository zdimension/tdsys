...
{
    TraceFile << "calloc(" << args->num << "," << ADDRINTToHexString(args->size) + ") = " + ADDRINTToHexString(ret)
              << endl;
}
...
{
    TraceFile << "realloc(" << ADDRINTToHexString(args->addr) << "," << args->size << ") = " << ADDRINTToHexString(ret)
              << endl;
}
